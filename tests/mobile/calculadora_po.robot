...
Calculo
    ...
    #adicao
    ${elemento1}=    Set Variable    accessibility_id=${numero1}
    Click Element    ${elemento1}

    ${elemento2}=    Set Variable    accessibility_id=plus
    Click Element    ${elemento2}

    ${elemento3}=    Set Variable    accessibility_id=${numero2}
    ...
    #subtracao
    ${elemento5}=    Set Variable    accessibility_id=${numero1}
    Click Element    ${elemento5}

    ${elemento6}=    Set Variable    accessibility_id=minus
    Click Element    ${elemento6}

    ${elemento7}=    Set Variable    accessibility_id=${numero2}
    ...
    #divisao
    ${elemento13}=    Set Variable    accessibility_id=${numero1}
    Click Element    ${elemento13}

    ${elemento14}=    Set Variable    accessibility_id=divide
    Click Element    ${elemento14}

    ${elemento15}=    Set Variable    accessibility_id=${numero2}
